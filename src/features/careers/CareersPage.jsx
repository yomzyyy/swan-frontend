        ...
        <div className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200 p-8">
              ...
              <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 border-2 border-cyan-200 p-8">
                <div className="w-16 h-16 bg-[#207dff] rounded-full flex items-center justify-center mb-6">
                  <span className="text-3xl">📚</span>
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 border-2 border-indigo-200 p-8">
                <div className="w-16 h-16 bg-[#207dff] rounded-full flex items-center justify-center mb-6">
                  <span className="text-3xl">💼</span>
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4">
          ...
          <div className="max-w-7xl mx-auto px-8">
            ...
            <div className="space-y-6">
              {Array(5).fill(0).map((_, i) => (
                <SkeletonCard key={i} variant="career" />
              ))}
            </div>
          </div>
        </div>
