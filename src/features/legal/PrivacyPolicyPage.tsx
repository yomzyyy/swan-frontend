        ...
        <div className="bg-white rounded-3xl p-12 shadow-lg space-y-8">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              SWAN Shipping Corporation ("we," "our," or "us") is committed to protecting your privacy.
            ...
            <div className="space-y-4 ml-6">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  you choose to participate in various activities related to the Site, such as requesting
                  quotes or signing up for our newsletter.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  return, exchange, or request information about our services from the Site.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc ml-6 space-y-2 text-gray-700">
              <li>Process your shipping requests and manage your account</li>
              <li>Send you shipping notifications and service updates</li>
              <li>Respond to inquiries and offer customer support</li>
              <li>Comply with maritime regulations and safety requirements</li>
          ...
          <section>
            ...
            <ul className="list-disc ml-6 space-y-2 text-gray-700">
              <li><strong>By Law or to Protect Rights:</strong> If we believe the release of information is necessary to comply with legal obligations or protect our rights</li>
              ...
              <li><strong>Third-Party Service Providers:</strong> We may share your information with contractors, service providers, and other third parties we use to support our business</li>
              <li><strong>Port Authorities and Customs:</strong> We share necessary information with port authorities and customs officials as required for maritime operations</li>
            </ul>
          </section>
